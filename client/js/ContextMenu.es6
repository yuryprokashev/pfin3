...
class ContextMenu {
    ...
    setOptionsAsync() {
        ...
        this.options[0].getUrl = `browser/api/v1/command/copy/${cm.monthString}/${pm.monthString}/${payloadType}`;
        this.options[1].name = `clear ${cm.html.formattedMonth}`;
        this.options[1].getUrl = `browser/api/v1/command/clear/${cm.monthString}/${undefined}/${payloadType}`;
    }
