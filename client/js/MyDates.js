...
MyDates = function () {
    ...
    // return: String month
    var getMonth = function getMonth(string) {
        if (string.length >= 6) {
    ...
    // return: String year
    var getYear = function getYear(string) {
        if (string.length >= 4) {
    ...
    // return: integer
    var daysInMonth = function daysInMonth(string) {
        var number = 30;
    ...
    var weeksInMonth = function weeksInMonth(t) {
        var weeks = 1;
    ...
    // return: int firstDay
    var firstDayOfMonth = function firstDayOfMonth(t) {
    ...
    // return: String t
    var dateToTimeWindowString = function dateToTimeWindowString(date, def) {
        if (!def) {
            def = { y: 1, m: 1, d: 1 };
        }
        var t;
    ...
    function stringToTimeWindow(string) {
        ...
        var isAllowedLength = function isAllowedLength(element, index, array) {
    ...
    // return: String
    var timeWindowToFormattedString = function timeWindowToFormattedString(t, s) {
        if (t.year) {
    ...
    var explode = function explode(t, range) {
        var result = [];
    ...
    // return: int level
    var explosionIndex = function explosionIndex(t) {
    ...
    var definitiveIndex = function definitiveIndex(t) {
    ...
    // function: convert TimeWindow to array of embedded TimeWindows.
    // return: Array [TimeWindow]
    var explode2 = function explode2(t, range, start) {
        var result = [];
    ...
    var parentLength = function parentLength(string) {
        if (string.length === 4) {
            return 4;
        }
        if (string.length === 6) {
    ...
    var getParent = function getParent(string) {
        if (string === "0000") {
            return null;
    ...
    // return: Array [TimeWindow]
    var getNeighbours = function getNeighbours(t, range) {
        var result = [];
    ...
    // return: String day
    var dayToString = function dayToString(dayNum) {
        var day;
    ...
    // return: int result
    var numberOfWeek = function numberOfWeek(date) {
        var result = null;
    ...
    var nowInMilliseconds = function nowInMilliseconds() {
        return new Date().valueOf();
        // return Date.parse(new Date());
    };

    var monthAsLabel = function monthAsLabel(t, isLong) {
...
//# sourceMappingURL=MyDates.js.map