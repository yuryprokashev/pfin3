...
KafkaAdapter = function KafkaAdapter() {
    ...
    var setUpProducer = function setUpProducer(kafkaClient) {
    ...
    var setUpConsumer = function setUpConsumer(kafkaClient) {
    ...
    var subscribe = function subscribe(topic, callback) {
        var topics = [{ topic: topic, partition: 0 }, { topic: topic, partition: 1 }, { topic: topic, partition: 2 }, { topic: topic, partition: 3 }, { topic: topic, partition: 4 }, { topic: topic, partition: 5 }];
