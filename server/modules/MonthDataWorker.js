...
var MonthDataWorker = function (_Worker) {
    _inherits(MonthDataWorker, _Worker);

    function MonthDataWorker(id, commandId) {
        _classCallCheck(this, MonthDataWorker);

        return _possibleConstructorReturn(this, (MonthDataWorker.__proto__ || Object.getPrototypeOf(MonthDataWorker)).call(this, id, commandId));
    }

    _createClass(MonthDataWorker, [{
        key: 'handle',
    ...
    return MonthDataWorker;
}(Worker);

module.exports = MonthDataWorker;

//# sourceMappingURL=MonthDataWorker.js.map